...
$this->params['breadcrumbs'][] = ['label'=>$materi->post_title,'url'=>['site/tugas','jadwal_id'=>$jadwal->jadwal_id,'materi_id'=>$materi_id,'id'=>$id]];
$this->params['breadcrumbs'][] = 'Tambah Soal'; //$materi->post_title;
?>
